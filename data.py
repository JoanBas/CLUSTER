...
class dataset():
    def __init__(self,dataset_name='handson3',event_kinds=['tools','creations']):
        ...
        self.total_event_kinds=['views','edits','comments','tools','creations']
    ...
    def get_data(self, filename,no_facilitators=True):
        ...
        directori = os.path.abspath(os.path.join(directori, os.pardir) + '/DADES2/'+self.dataset_name)
        ...
        for line in file:
            ...
            user = w[0]
            if no_facilitators:
                if user in facilitators: continue
    ...
    def facilitators(self):
        facilitators={}
        facilitators['handson2']=['2','987','993','999','1006','1338'] #del de la davinia no nestic segur
        facilitators['handson3']=['846','849','852','875','885','892','923','926','929','932','935','942','954','979','990','997','1038']
        facilitators['demo']=[]
        return facilitators[self.dataset_name]
    ...
    def prepare_multivariate(self, data="none", ids="none", combined=0, compute_distributions=0, add_start_end_sess=0):
